...
header:
 image: images/Neural Networks/RBM/model.png
---
# Introdcution
...
From my understanding, one of the uses for RBM's are for suggestions. Without
...
how this model works. One of the more digestible methods I have found is
...
**SHOW THE MATHS FROM THE PAPER NAJEE DONT FORGET**
...
Godzilla with the microwave. I peed my pants.
In both training and testing, I had a relatively low loss value, which I would
chalk up as a success. My full code can be viewed [here](github.com/najeesmith)
